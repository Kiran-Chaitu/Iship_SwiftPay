...
import 'package:SwiftPay/qr_code_scanner.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<Map<String, String>> notifications = [
    ...
    {"title": "Recharge Reminder", "subtitle": "Recharge due for 1234567890"},
    {
      "title": "New Offer",
      "subtitle": "Get 10% cashback on your next bill payment"
    },
  ];
  ...
  void _showNotifictionsDialouge(BuildContext context) {
    showDialog(
        context: context,
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Container(
            ...
            child: IconButton(
              onPressed: () {
                _showNotifictionsDialouge(context);
              },
