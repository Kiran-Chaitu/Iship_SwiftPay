    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          leading: Container(
            margin: const EdgeInsets.only(left: 10, top: 5, bottom: 3),
...
class AccountDetailsScreen extends StatefulWidget {
  ...
  const AccountDetailsScreen({super.key, required this.appBarName});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: const Text(
                'This allows Swift Pay to fetch your current and future ',
              ),
            ),
            Center(
              child: const Text(
                'bills so that you can view and pay them.',
              ),
            ),
            const SizedBox(height: 20),
            InkWell(
